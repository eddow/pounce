				...
				<for each={stack.stack}>
					{(entry) => (
						<div
							...
							${entry.spec.variant === 'danger' ? 'background: #991b1b; border: 1px solid #dc2626;' : ''}
							${entry.spec.variant === 'warning' ? 'background: #854d0e; border: 1px solid #d97706;' : ''}
							${entry.spec.variant === 'primary' || !entry.spec.variant ? 'background: #1e40af; border: 1px solid #2563eb;' : ''}
						`}
						>

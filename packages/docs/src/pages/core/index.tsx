		...
		<article>
			...
			<Section title="Architecture">
				...
				<ol>
					...
					<li>
						<strong>Reconciler</strong> (<code>reconcile</code>) syncs children to the DOM —{' '}
						<code>latch()</code> is the public API for latching content onto any element
					</li>
					<li>
						<strong>Reactive updates</strong> — when a <code>mutts</code> dependency changes, only
						the specific text node, attribute, or child list updates
					</li>
				</ol>
			</Section>
			...
			<Section title="Topics">
				<ul>
					<li>
						<A href="/core/jsx">JSX Factory</A> — <code>h()</code>, <code>r()</code>,{' '}
					...
					<li>
						...
						<code>{'<env>'}</code> element
					</li>
					<li>
						<A href="/core/ssr">SSR</A> — Node entry point, JSDOM, AsyncLocalStorage
					</li>
				</ul>
			</Section>
		</article>

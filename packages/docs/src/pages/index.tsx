...
export default function IndexPage() {
	return (
		<article>
			<h1>Pounce</h1>
			<p>
				A <strong>component-oriented UI framework</strong> with fine-grained reactivity and direct
				DOM manipulation. Familiar JSX syntax, no virtual DOM.
			</p>
				...
				<table>
					...
					<tbody>
						...
						<tr>
							...
							<td>15+ components, overlays, display context, adapter pattern</td>
						</tr>
						<tr>
							<td>
						...
						<tr>
							...
							<td>Reactive primitives: signals, effects, reactive objects/arrays/sets/maps</td>
						</tr>
						<tr>
							<td>
								<code>pure-glyf</code>
							</td>
							<td>Icon system: SVG → CSS classes, Vite plugin</td>
						</tr>
					</tbody>
				</table>
			</Section>

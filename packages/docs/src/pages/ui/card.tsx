...
import { Card, Button, Select, Switch, Stack, Inline } from '@pounce/ui'
...
export default function CardPage() {
  return (
    <article>
      <h1>Card</h1>
      <p>
        Semantic card component using <code>{'<article>'}</code>.
        Composable with <code>Card.Header</code>, <code>Card.Body</code>, and <code>Card.Footer</code> sub-components.
      </p>
      ...
      <Section title="API Reference">
        ...
        <ApiTable props={[
          ...
          { name: 'el', type: 'JSX.GlobalHTMLAttributes', description: 'Pass-through HTML attributes on the <article>', required: false },
          { name: 'children', type: 'JSX.Children', description: 'Card content — typically Card.Header, Card.Body, Card.Footer', required: false },
        ]} />
        ...
        <ApiTable props={[
          ...
          { name: 'children', type: 'JSX.Children', description: 'Section content', required: false },
        ]} />
      </Section>
    </article>
  )

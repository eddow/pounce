...
const state = reactive({
	...
	dynamicComponentTag: FancyDynamicComponent as ComponentFunction,
...
function DynamicDemo() {
	return (
		<section data-testid="dynamic-demo">
			<dynamic
				tag={state.dynamicTag}
				class="dynamic-root"
				data-testid="dynamic-root"
				data-kind={typeof state.dynamicTag === 'function' ? 'component' : state.dynamicTag}
				is={state.dynamicIs}
			>

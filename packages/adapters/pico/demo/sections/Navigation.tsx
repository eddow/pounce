...
const accordionItems = [
	{
		id: 'intro',
		title: 'What is pico?',
		body: 'A tiny CSS adapter layer around the headless Sursaut UI models.',
	},
	{
		id: 'reactivity',
		title: 'How does precedence work?',
		body: 'Passthrough props spread first, then model-owned semantics override when needed.',
	},
]
			...
			<DemoGrid>
				<DemoCard title="Links + Menu.Bar">
					<Menu.Bar
						...
						items={[<A href="/buttons">Buttons</A>, <A href="/options">Options</A>]}
				...
				<DemoCard title="Menu">
					<Menu summary="Actions">
						<ul role="menu">
							<li role="none">
								<Menu.Item href="/buttons">Open buttons</Menu.Item>
							</li>
							<li role="none">
								<Menu.Item href="/status">Open status</Menu.Item>
							</li>
						</ul>
					</Menu>
				</DemoCard>
